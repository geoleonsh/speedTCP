...
#安装包下载地址
INSTALLPACK=https://github.com/geoleonsh/speedTCP/blob/test/91yunserverspeeder.tar.gz?raw=true
#判断版本支持情况的地址
CHECKSYSTEM=https://raw.githubusercontent.com/geoleonsh/speedTCP/test/serverspeederbin.txt
#bin下载地址
